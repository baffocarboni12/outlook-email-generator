...
import random
try:
    os.system('pip install secrets && pip install uuid && pip install requests && pip install faker && pip install captcha_solver && pip install selenium && cls')
except:
    pass
...
API_2_CAPTCHA = input('TwoCaptcha Key: ')
